...
symbol = st.sidebar.text_input("Enter stock symbol (Note: For Indian Stocks add .NS after symbol)", "AAPL")

# Get historical stock price data
data = yf.download(symbol, start="2010-01-01", end="2023-03-27")
